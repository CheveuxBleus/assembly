...
p6:	.asciiz "Hoje é (Dom - 1 / Seg - 2 / Ter - 3 / Qua - 4 / Qui - 5 / Sex - 6 / Sab - 7): "
p7:	.asciiz "Data inválida"
p8:	.asciiz "Você nasceu em um Domingo"
p9:	.asciiz "Você nasceu em uma Segunda"
p10:	.asciiz "Você nasceu em uma Terça"
p11:	.asciiz "Você nasceu em uma Quarta"
p12:	.asciiz "Você nasceu em uma Quinta"
p13:	.asciiz "Você nasceu em uma Sexta"
p14:	.asciiz "Você nasceu em um Sábado"
...
#ANO ATUAL:
	...
	add $10, $0, $2 #Ano => $13
#DIA DA SEMANA:
	lui $4, 0x1001  #"Hoje é (Dom - 1 / Seg - 2 / Ter - 3 / Qua - 4 / Qui - 5 / Sex - 6 / Sab - 7): " - p6
	addi $4, $4, 0x47
	addi $2, $0, 4
	syscall
	addi $2, $0, 5 #recebe dia da semana
	syscall
	add $15, $0, $2 #Dia => $15	

#$5 = dia_nasc / $6 = mes_nasc / $7 = ano_nasc / $8 = dia_atual / $9 = mes_atual / $10 = ano_atual
#$11 = total de dias / $15 = dia da semana
...
fim:	addi $12, $0, 7 #$12 = 7
	div $11, $12 #total de dias / 7
	mfhi $13 #13 = resto
	add $15, $15, $12 #dia da semana = dia da semana + 7
	sub $15, $15, $13 # dia da semana = (dia da semana + 7) - resto
	slt $13, $12, $15 #se dia da semana é maior ou menor a 7
	beq $13, $0, print #se dias da semana for menor que sete = print
	sub $15, $15, $12 #se nao, dia da semana = dia da semana - 7

#Print o dia da semana 
...
dom:	lui $4, 0x1001 #print "Você nasceu em um Domingo" - p8
	addi $4, $4, 0xa4
	addi $2, $0, 4
	syscall
	j fim2

seg:	lui $4, 0x1001 #print "Você nasceu em uma Segunda" - p9
	addi $4, $4, 0xbe
	addi $2, $0, 4
	syscall
	j fim2
	
ter:	lui $4, 0x1001 #print "Você nasceu em uma Terça" - p10
	addi $4, $4, 0xd9
	addi $2, $0, 4
	syscall
	j fim2

qua:	lui $4, 0x1001 #print "Você nasceu em uma Quarta" - p11
	addi $4, $4, 0xf2
	addi $2, $0, 4
	syscall
	j fim2
	
qui:	lui $4, 0x1001 #print "Você nasceu em uma Quinta" - p12
	addi $4, $4, 0x10c
	addi $2, $0, 4
	syscall
	j fim2
	
sex:	lui $4, 0x1001 #print "Você nasceu em uma Sexta" - p13
	addi $4, $4, 0x126
	addi $2, $0, 4
	syscall
	j fim2
	
sab:	lui $4, 0x1001 #print "Você nasceu em um Sabado" - p14
	addi $4, $4, 0x13f
	addi $2, $0, 4
	syscall
	j fim2
